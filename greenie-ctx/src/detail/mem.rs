...
#[cfg(target_family = "windows")]
pub const fn stack_default_size() -> usize {
    128 * 1024
}
#[cfg(target_family = "windows")]
pub const fn stack_is_unbounded() -> bool {
    true
}

#[cfg(target_family = "windows")]
pub const fn stack_maximum_size() -> usize {
    1 * 1024 * 1024 * 1024 // 1GB
}
#[cfg(target_family = "windows")]
pub const fn stack_minimum_size() -> usize {
    MIN_SIZE
}
...
lazy_static::lazy_static! {
    ...
    pub static ref LIMIT: libc::rlimit = {
        unsafe {
            let mut l = core::mem::zeroed();
            libc::getrlimit(libc::RLIMIT_STACK,&mut l);
            l
        }
    };
}
#[cfg(target_family = "unix")]
pub fn stack_is_unbounded() -> bool {
    libc::RLIM_INFINITY == LIMIT.rlim_max
}
#[cfg(target_family = "unix")]
pub const fn stack_default_size() -> usize {
    128 * 1024
...
#[cfg(target_family = "unix")]
pub fn stack_maximum_size() -> usize {
